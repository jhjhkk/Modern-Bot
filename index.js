...
let tamnel = fs.readFileSync('./media/alazery.jpg')
let tde = fs.readFileSync('./media/truth.jpg')

//Function RPG & LEVEL By Alazery Ori
...
//Database RPG Mode By Alazery!! Ori No
...
//»»»𝘔𝘢𝘬𝘦𝘳 𝘔𝘦𝘯𝘶          
  // Textprome //
    ...
    case 'horrorblood':   case 'thunder':
          if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply(mess.limit)
          if (args.length == 0) return reply(`Example: ${prefix + command} Rstext`)
          ini_txt = args.join(" ")
